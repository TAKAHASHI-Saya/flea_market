...
<div class="content">
    <div class="content__group">
        ...
        <form action="{{route('update.mypage')}}" method="post" class="form" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="form__image-group">
                <div class="form__image-preview">
                    <img id="imagePreview" src="{{asset('storage/' . $user->profile_image)}}" alt="プロフィール画像" class="form__image">
                </div>
            ...
            <div class="form__group">
                ...
                <div class="form__input">
                    <input type="text" name="username" value="{{old('username', $user->username)}}" class="form__input-item">
                </div>
                <div class="form__error">
            ...
            <div class="form__group">
                ...
                <div class="form__input">
                    <input type="text" name="postcode" value="{{old('postcode', $user->postcode)}}" inputmode="numeric" class="form__input-item">
                </div>
                <div class="form__error">
            ...
            <div class="form__group">
                ...
                <div class="form__input">
                    <input type="text" name="address" value="{{old('address', $user->address)}}" class="form__input-item">
                </div>
                <div class="form__error">
            ...
            <div class="form__group">
                ...
                <div class="form__input">
                    <input type="text" name="building" value="{{old('building', $user->building ?? '')}}" class="form__input-item">
                </div>
                <div class="form__error">
